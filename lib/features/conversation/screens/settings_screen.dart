...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _loadSettings() async {
    _apiKeyController.text = getStringAsync(GEMINI_API_KEY);
    _n8nUrlController.text = getStringAsync(N8N_BASE_URL, defaultValue: 'https://tu-instancia-n8n.com');
    _n8nTokenController.text = getStringAsync(N8N_WEBHOOK_TOKEN);
  }
  ...
  Future<void> _saveSettings() async {
    ...
    await setValue(GEMINI_API_KEY, apiKey);

    if (n8nUrl.isNotEmpty) {
      await setValue(N8N_BASE_URL, n8nUrl);
    }

    if (n8nToken.isNotEmpty) {
      await setValue(N8N_WEBHOOK_TOKEN, n8nToken);
    }

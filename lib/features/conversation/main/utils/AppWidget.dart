...
import '../screens/ProKitLauncher.dart';
    ...
    child: Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          detail ?? Icon(Icons.arrow_forward_ios, size: 16, color: Colors.black),
        ],
...
String? getBannerAdUnitId() {
  if (kReleaseMode) {
    if (Platform.isIOS) {
      return bannerAdIdForIosRelease;
...
String getInterstitialAdUnitId() {
  if (kReleaseMode) {
    if (Platform.isIOS) {
      return interstitialAdIdForIosRelease;
    } else if (Platform.isAndroid) {

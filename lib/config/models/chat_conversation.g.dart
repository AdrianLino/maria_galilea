...
ChatConversation _chatConversationDeserialize(
  ...
  final object = ChatConversation(
    ...
    modelName: reader.readStringOrNull(offsets[3]) ?? 'gemini-2.0-flash',
...
extension ChatConversationQuerySortBy
  ...
  QueryBuilder<ChatConversation, ChatConversation, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatConversationQuerySortThenBy
  ...
  QueryBuilder<ChatConversation, ChatConversation, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }
...
extension ChatConversationQueryWhereDistinct
  ...
  QueryBuilder<ChatConversation, ChatConversation, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ChatConversationQueryProperty
  ...
  QueryBuilder<ChatConversation, String, QQueryOperations> modelNameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'modelName');
    });
  }

  QueryBuilder<ChatConversation, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
